...
def render_sidebar():
    with st.sidebar:
        ...
        # Navigation buttons
        if st.button("Home", key="nav_home", help="Go to the home page"):            st.session_state.current_page = "Home"
            st.experimental_rerun()
            
        if st.button("Upload Material", key="nav_upload", help="Upload and process learning materials"):            st.session_state.current_page = "Upload"
            st.experimental_rerun()
            
        if st.button("Lessons", key="nav_lessons", help="View and explain lessons"):            st.session_state.current_page = "Lessons"
            st.experimental_rerun()
            
        if st.button("Quizzes", key="nav_quizzes", help="Take quizzes on lesson content"):            st.session_state.current_page = "Quizzes"
            st.experimental_rerun()
            
        if st.button("Progress Reports", key="nav_reports", help="View your progress reports"):            st.session_state.current_page = "Reports"
            st.experimental_rerun()
        ...
        if st.session_state.user and st.session_state.user.get('is_admin', False):
            ...
            if st.button("Manage Users", key="nav_admin_users"):                st.session_state.current_page = "Admin_Users"
                st.experimental_rerun()
                
            if st.button("Generate Invites", key="nav_admin_invites"):                st.session_state.current_page = "Admin_Invites"
                st.experimental_rerun()
...
def render_admin_invites_page():
    ...
    with st.form("generate_invite"):        st.markdown("#### Generate New Invite")
...
def main():
    ...
    elif st.session_state.current_page == "Upload":        render_upload_page()
    elif st.session_state.current_page == "Lessons":        render_lessons_page()
    elif st.session_state.current_page == "Quizzes":        render_quizzes_page()
    elif st.session_state.current_page == "Reports":        render_reports_page()
    elif st.session_state.current_page == "Admin_Users":        render_admin_users_page()
    elif st.session_state.current_page == "Admin_Invites":        render_admin_invites_page()
    else:
